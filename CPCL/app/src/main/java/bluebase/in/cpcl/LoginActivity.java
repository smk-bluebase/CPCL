...
public class LoginActivity extends AppCompatActivity {
    ...
    String urlLogin = CommonUtils.IP + "/CPCL/cpclandroid/login.php";
    String urlForgotPassword = CommonUtils.IP + "/CPCL/cpclandroid/forgotpasswordgenerator.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userNameEditText1.setText("admin");
